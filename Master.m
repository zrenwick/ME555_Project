...
% 
% ga_1_popsize = 10000;
% good_solutions = [335433722;475297863;25034347];
% 
% init_pop_1 = [randi([1,factorial(n_points)],ga_1_popsize - numel(good_solutions),1);good_solutions];
% 
% opts = gaoptimset(...
